---
title: "Using Hangler on a More Complex Curve"
...
At this point we *could* resample. But it's not necessary because modern
computers can calculate FFTs on any sized array. The only reason we may now
need to do it, is to artificially increase the nyquist frequency.
